const BlogsData = [
  ...
  },
  {
    ...
    nivel nacional`,
    text: `En el sur del departamento del Cauca se dio inicio a un ambicioso proyecto, la 
        Granja Solar Las Marías, una solución energética que se construye, 
        aprovechando el poder del sol y las mejores tecnologías, para dar al servicio de 
        los colombianos 99.5 megavatios de energía sostenible.
        
        Esta iniciativa, que se suma a los grandes proyectos del país que buscan seguir 
        la ruta de la transición energética trazada en el Plan Nacional del Desarrollo, se 
        construye a 40 minutos del municipio de Bolívar, y se constituye en una 
